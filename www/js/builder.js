$(document).ready(function() {
    ...
    function okQuerySimbCons(tx, results) {
        ...
        for (var i=0; i<len; i++) {
	    	...
	    	if (localStorage.dinamico == "iOS") {
	    		$(".planos").append("<a href='usar-plano.html'>"
								 +"<img src='img/"+results.rows.item(i).img+"' title='"+results.rows.item(i).audio+"' alt='"+results.rows.item(i).plano+"'  class='img-plano' style='margin-bottom:13px; border:10px solid "+corBorda+"' height='175' width='175' />"
								 +"</a>&nbsp;");
			}
	    	else {
	    		$(".planos").append("<a href='usar-plano.html'>"
								 +"<img src='"+results.rows.item(i).img+"' title='"+results.rows.item(i).audio+"' alt='"+results.rows.item(i).plano+"'  class='img-plano' style='margin-bottom:13px; border:10px solid "+corBorda+"' height='175' width='175' />"
								 +"</a>&nbsp;");
			}
	    }
	    $(".img-plano").click(function() {
