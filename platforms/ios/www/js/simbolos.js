        ...
        if (len > 0) {
	        ...
	        for (var i=0; i<len; i++) {
                ...
                if (localStorage.dinamico == "iOS") {
                    $(".simbolos").append("<div class = 'simbs col col-50'>"
                                        + "<a href='../prancha/prancha.html'>"
                                        + "<img src='img/"+results.rows.item(i).img+"' title='"+results.rows.item(i).audio+"'"
                                        + " alt='"+results.rows.item(i).plano+"' class='img-simb' style='margin:25px; border:10px solid "+corBorda+";"
